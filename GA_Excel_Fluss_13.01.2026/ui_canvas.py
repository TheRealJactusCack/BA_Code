...
import config
from helpers import cell_center_from_topleft, machine_input_point, machine_output_point
    ...
    def paintEvent(self, event):
        ...
        if self.layout_data:
            ...
            for m in self.layout_data:
                ...
                print("IDX", idx, "sizes", (w_size, d_size), "draw", (w_draw, h_draw), "center", (m["x"], m["y"]))
